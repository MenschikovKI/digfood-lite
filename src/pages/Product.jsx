...
const Product = ({token}) => {
    ...
    const move = (e) => {
        e.preventDefault();
        navigate("/catalog"); // переход на страницу с каталогом
    };
    ...
    return <Row className="my-4">
        ...
        <Col xs ={6}>
            ...
            <Row className="gx-5 my-3">
                ...
                <ButtonGroup>
                    ...
                    <Button variant="outline-secondary" >{cnt}</Button>
            ...
            <Alert variant="secondary">
                <Row>
                    ...
                    <Col xs={10}>
                        ...
                        <p className="mt-3 mb-0">Если Вам не понравилось качество нашей продукции, 
                        мы вернем деньги, либо сделаем все возможное, чтобы удовлетворить ваши нужды</p>
                    </Col>
                </Row>
            </Alert>
        </Col>
        ...
        <Col xs={12}>
            <h3 className="fw-bold">Характеристики</h3>
            <Table>
                <tbody>
        ...
        <Col xs={12}>
            <h3 className="fw-bold">Отзывы</h3>
